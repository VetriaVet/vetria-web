-- ============================================================================
-- SEED DA 0005 — OS 5571 MUNICÍPIOS DO IBGE EM public.cidades (T-028)
--
-- ⚠️ ARQUIVO GERADO. NÃO EDITE À MÃO. Para gerar de novo:
--      node supabase/gerar-seed-cidades.mjs
--
-- Fonte:  C:/Users/ELBERD~1/AppData/Local/Temp/claude/C--Users-Elber-Desinger-Desktop-Vetria-Vetria-Brasil/aaad75da-7c78-4fd3-8f4b-d7ae71c47501/scratchpad/municipios.json
-- Gerado: 2026-09-23 · 5571 municípios · 27 UFs
-- sha256 do JSON de origem: 77bf68d9f5b1237522bcd28c39b8857725ebb25e913a5b13aa4a740ce67041b4
--
...
select 0 as ordem, 'total de municipios' as item,
       ...
       (select count(*) from public.cidades)::text || ' de 5571' as leitura
union all
...
from (values ('AC', 22), ('AL', 102), ('AP', 16), ('AM', 62), ('BA', 417), ('CE', 184), ('DF', 1), ('ES', 78), ('GO', 246), ('MA', 217), ('MT', 142), ('MS', 79), ('MG', 853), ('PA', 144), ('PB', 223), ('PR', 399), ('PE', 185), ('PI', 224), ('RJ', 92), ('RN', 167), ('RS', 497), ('RO', 52), ('RR', 15), ('SC', 295), ('SP', 645), ('SE', 75), ('TO', 139)) as e(uf, n)
