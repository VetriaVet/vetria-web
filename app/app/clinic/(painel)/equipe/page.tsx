  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <EmptyState
        ...
        description="Você poderá convidar veterinários por email. Cada um preenche o próprio cadastro e, depois de validado, aparece aqui e no perfil público da clínica."
      />
