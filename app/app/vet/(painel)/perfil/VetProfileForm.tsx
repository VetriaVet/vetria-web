    ...
    <div className="grid lg:grid-cols-[1fr_320px] gap-8 items-start">
      ...
      <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-5 mb-6">
            ...
            <div>
              ...
              <p className="text-[12px] text-corpo-texto leading-relaxed mb-2">
                Tutores confiam mais em perfis com foto real. Mínimo 400×400px.
              </p>
              <button
                type="button"
                disabled
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Como tutores te encontram"
              />
            </div>
          </div>
        ...
        <Section
          ...
          desc="A primeira coisa que tutores leem sobre você"
        >
          <textarea
            rows={6}
            maxLength={BIO_MAX}
        ...
        {/* Localização */}
        <Section title="Localização" desc="Onde tutores podem te encontrar">
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
        ...
        <Section title="Como você atende" desc="Tutores filtram por essas opções">
          <div className="grid sm:grid-cols-3 gap-3">
            <ModeCard
              active={modos.presencial}
              onClick={() => toggleModo("presencial")}
              title="Presencial"
              desc="Em clínica ou consultório"
            />
            <ModeCard
              active={modos.domiciliar}
              onClick={() => toggleModo("domiciliar")}
              title="Domiciliar"
              desc="Visitas na casa do tutor"
            />
            <ModeCard
        ...
        {/* Contato */}
        <Section
          title="Como tutores te contatam"
      ...
      <aside className="lg:sticky lg:top-24 flex flex-col gap-4">
        ...
        <div className="rounded-2xl bg-fundo-claro/60 border border-gray-100 p-4">
          <p className="text-[12px] text-corpo-texto leading-relaxed">
            ...
            Quando a busca da Vetria for ao ar, ele aparece pra tutores da sua região.
          </p>
        </div>
      </aside>
    </div>
