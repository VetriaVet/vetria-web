...
export default function ClinicProfileForm({
  ...
  const nomePreview = nomeFantasia.trim() || initialName || "Seu estabelecimento";
  ...
  return (
    <div className="grid lg:grid-cols-[1fr_320px] gap-8 items-start">
      ...
      <div className="flex flex-col gap-6">
        <Section title="Identificação" desc="Como o estabelecimento aparece no perfil público">
          <div className="flex items-center gap-5 mb-6">
            ...
            <div>
              <p className="font-medium text-sm text-titulo mb-1">Logo do estabelecimento</p>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                placeholder="Como responsáveis conhecem o estabelecimento"
              />
            </div>
            <div>
        ...
        <Section title="Sobre o estabelecimento" desc="O que responsáveis leem primeiro">
          <textarea
            rows={6}
            maxLength={BIO_MAX}
            value={sobre}
            onChange={(e) => setSobre(e.target.value)}
            placeholder="Conte a história do estabelecimento, estrutura e diferenciais. Fale com naturalidade."
        ...
        <Section title="Serviços e estrutura" desc="O que o estabelecimento oferece">
        ...
        <Section title="Localização" desc="Onde responsáveis encontram o estabelecimento">
          <div>
        ...
        <Section title="Contato" desc="Como responsáveis falam com o estabelecimento">
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
      ...
      <aside className="lg:sticky lg:top-24 flex flex-col gap-4">
        ...
        <div className="rounded-2xl bg-fundo-claro/60 border border-gray-100 p-4">
          <p className="text-[12px] text-corpo-texto leading-relaxed">
            O estabelecimento <strong className="text-titulo">ainda não está público</strong>.
            Quando a busca da Vetria for ao ar, ele aparece pra responsáveis da região.
          </p>
        </div>
      </aside>
    </div>
