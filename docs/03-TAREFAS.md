...
- **Estado:** 🟡 **implementada na árvore em 21/09, NÃO COMMITADA.** Aguarda revisão do `vetria-seguranca` e aprovação do diff pelo Elber. `npm run build` e `npm run lint` verdes
- **Fase / Semana:** F3 / S4
...
- **Resultado (21/09/2026, `vetria-backend`): a fila existe, lê o banco e abre o documento. 8 arquivos, nada commitado.**
